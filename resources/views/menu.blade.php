...
@section('content')
<div class="bg-amber-50 py-12 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-10">
        <!-- Sidebar Categories -->
        <aside class="w-full lg:w-1/4 mb-10 lg:mb-0">
            <div class="bg-white rounded-xl shadow-lg p-6 sticky top-24">
                <h2 class="text-xl font-bold text-gray-800 playfair mb-4">Categories</h2>
                <ul class="space-y-2">
                    <li><a href="#appetizers" class="block px-4 py-2 rounded hover:bg-amber-100 text-amber-700 font-semibold transition">Appetizers</a></li>
                    <li><a href="#pasta" class="block px-4 py-2 rounded hover:bg-amber-100 text-amber-700 font-semibold transition">Pasta & Risotto</a></li>
                    <li><a href="#mains" class="block px-4 py-2 rounded hover:bg-amber-100 text-amber-700 font-semibold transition">Main Courses</a></li>
                    <li><a href="#seafood" class="block px-4 py-2 rounded hover:bg-amber-100 text-amber-700 font-semibold transition">Seafood</a></li>
                    <li><a href="#desserts" class="block px-4 py-2 rounded hover:bg-amber-100 text-amber-700 font-semibold transition">Desserts</a></li>
                    <li><a href="#drinks" class="block px-4 py-2 rounded hover:bg-amber-100 text-amber-700 font-semibold transition">Drinks</a></li>
                </ul>
                <div class="mt-8 text-center">
                    <a href="#reservation" class="inline-block px-6 py-3 bg-amber-600 text-white font-semibold rounded hover:bg-amber-700 transition">Make a Reservation</a>
                </div>
            </div>
        </aside>
        <!-- Main Menu Content -->
        <main class="flex-1">
            ...
            <!-- Appetizers Section -->
            <section id="appetizers" class="mb-16 scroll-mt-24">
                <div class="flex items-center mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 playfair flex-1">Appetizers</h2>
                    <div class="h-1 w-16 bg-amber-600"></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-amber-200 transition">
            ...
            <!-- Pasta Section -->
            <section id="pasta" class="mb-16 scroll-mt-24">
                <div class="flex items-center mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 playfair flex-1">Pasta & Risotto</h2>
                    <div class="h-1 w-16 bg-amber-600"></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-amber-200 transition">
            ...
            <section id="mains" class="mb-16 scroll-mt-24">
                <div class="flex items-center mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 playfair flex-1">Main Courses</h2>
                    <div class="h-1 w-16 bg-amber-600"></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-amber-200 transition">
            ...
            <!-- Seafood Section -->
            <section id="seafood" class="mb-16 scroll-mt-24">
                <div class="flex items-center mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 playfair flex-1">Seafood</h2>
                    <div class="h-1 w-16 bg-amber-600"></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-amber-200 transition">
            ...
            <!-- Desserts Section -->
            <section id="desserts" class="mb-16 scroll-mt-24">
                <div class="flex items-center mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 playfair flex-1">Desserts</h2>
                    <div class="h-1 w-16 bg-amber-600"></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-amber-200 transition">
            ...
            <!-- Drinks Section -->
            <section id="drinks" class="mb-16 scroll-mt-24">
                <div class="flex items-center mb-8">
                    <h2 class="text-3xl font-bold text-gray-800 playfair flex-1">Drinks</h2>
                    <div class="h-1 w-16 bg-amber-600"></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-amber-200 transition">
